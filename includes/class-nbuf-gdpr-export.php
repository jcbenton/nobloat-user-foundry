...
<body>
    ...
    <p>' . esc_html__( 'If you have questions about this export or your data rights, please contact the site administrator.', 'nobloat-user-foundry' ) . '</p>
	...
	private static function create_nbuf_export( $dir, $user_id ) {
		...
		$export = array(
			...
			'account_settings' => array(
				...
				'expiration_date'    => ( $user_data && property_exists( $user_data, 'expiration_date' ) ) ? $user_data->expiration_date : null,
			),
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
	...
	public static function shortcode() {
		...
		$template = NBUF_Template_Manager::load_template( 'account-data-export-html' );
	...
	public static function enqueue_scripts() {
		...
		/* Enqueue data export CSS via CSS Manager */
		NBUF_CSS_Manager::enqueue_css(
			'nbuf-data-export',
			'data-export',
			'nbuf_data_export_custom_css',
			'nbuf_css_write_failed_data_export'
		);
		...
		<table class="form-table">
			<tr>
				...
				<td>
					...
					<div id="nbuf-admin-export-status" class="nbuf-export-status"></div>
				</td>
			</tr>
		</table>
		<?php
