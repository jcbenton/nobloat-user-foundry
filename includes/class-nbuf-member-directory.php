...
class NBUF_Member_Directory {
	...
	public static function enqueue_scripts() {
		...
		wp_enqueue_style(
			'nbuf-directory',
			plugin_dir_url( dirname( __FILE__ ) ) . 'assets/css/frontend/member-directory.css',
			array(),
			NBUF_VERSION
		);
		...
		wp_enqueue_script(
			'nbuf-directory',
			plugin_dir_url( dirname( __FILE__ ) ) . 'assets/js/frontend/member-directory.js',
			array( 'jquery' ),
			NBUF_VERSION,
			true
		);

		wp_localize_script( 'nbuf-directory', 'nbufDirectory', array(
	...
	public static function render_directory( $atts ) {
		...
		$members = self::get_members( array(
	...
	public static function get_members( $args = array() ) {
		...
		} elseif ( $orderby === 'user_registered' ) {
