...
class NBUF_QR_Code {
	...
	public static function generate_data_uri( $data, $size = 200, $padding = 2 ) {
		 ...
		 *
		 */
		// phpcs:ignore WordPress.PHP.DiscouragedPHPFunctions.obfuscation_base64_encode -- Used for QR code SVG data URI encoding, not code obfuscation.
