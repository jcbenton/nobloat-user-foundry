...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="nbuf-registration-form">
	...
	<p class="description" style="margin-top: 20px;">
		...
		<?php
		printf(
			/* translators: %s: Link to Profile Fields tab */
			esc_html__( 'Configure which fields appear on the registration form in %s.', 'nobloat-user-foundry' ),
			'<a href="' . esc_url( admin_url( 'admin.php?page=nobloat-user-foundry&tab=users&subtab=profile-fields' ) ) . '">' . esc_html__( 'Users → Profile Fields', 'nobloat-user-foundry' ) . '</a>'
		);
		?>
	</p>
