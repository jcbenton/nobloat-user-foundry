...
if ( isset( $_POST['nbuf_save_styles'] ) && check_admin_referer( 'nbuf_styles_save', 'nbuf_styles_nonce' ) ) {
	...
	*/
	...
	$nbuf_twofa_css        = isset( $_POST['2fa_setup_css'] ) ? NBUF_CSS_Manager::sanitize_css( wp_unslash( $_POST['2fa_setup_css'] ) ) : '';
	...
	NBUF_Options::update( 'nbuf_2fa_setup_css', $nbuf_twofa_css, false, 'css' );

	/* Try to write to disk with minification */
	$nbuf_reset_success        = NBUF_CSS_Manager::save_css_to_disk( $nbuf_reset_css, 'reset-page', 'nbuf_css_write_failed_reset' );
	$nbuf_login_success        = NBUF_CSS_Manager::save_css_to_disk( $nbuf_login_css, 'login-page', 'nbuf_css_write_failed_login' );
	$nbuf_registration_success = NBUF_CSS_Manager::save_css_to_disk( $nbuf_registration_css, 'registration-page', 'nbuf_css_write_failed_registration' );
	$nbuf_account_success      = NBUF_CSS_Manager::save_css_to_disk( $nbuf_account_css, 'account-page', 'nbuf_css_write_failed_account' );
	$nbuf_twofa_success        = NBUF_CSS_Manager::save_css_to_disk( $nbuf_twofa_css, '2fa-setup', 'nbuf_css_write_failed_2fa' );
	...
	if ( $nbuf_css_combine_files ) {
		...
		$nbuf_combined_success = NBUF_CSS_Manager::save_css_to_disk( $nbuf_combined_css, 'nobloat-combined', 'nbuf_css_write_failed_combined' );
	}

	/* Show appropriate message */
	if ( $nbuf_reset_success && $nbuf_login_success && $nbuf_registration_success && $nbuf_account_success && $nbuf_twofa_success && $nbuf_combined_success ) {
	...
	} elseif ( ! $nbuf_reset_success || ! $nbuf_login_success || ! $nbuf_registration_success || ! $nbuf_account_success || ! $nbuf_twofa_success || ! $nbuf_combined_success ) {
...
$nbuf_twofa_css        = NBUF_Options::get( 'nbuf_2fa_setup_css' );
...
<div class="nbuf-styles-tab">
	...
	<input type="hidden" name="nbuf_active_subtab" value="css-options">
