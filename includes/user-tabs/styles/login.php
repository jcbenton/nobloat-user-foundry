...
if ( isset( $_POST['nbuf_save_login_css'] ) && check_admin_referer( 'nbuf_login_css_save', 'nbuf_login_css_nonce' ) ) {
	...
	/* Write to disk */
	$success = NBUF_CSS_Manager::save_css_to_disk( $login_css, 'login-page', 'nbuf_css_write_failed_login' );
...
$has_write_failure = NBUF_CSS_Manager::has_write_failure( 'nbuf_css_write_failed_login' );
