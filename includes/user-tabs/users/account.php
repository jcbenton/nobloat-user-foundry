	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				<select name="nbuf_allow_email_change">
					<option value="disabled" <?php selected( $nbuf_allow_email_change, 'disabled' ); ?>>
						<?php esc_html_e( 'Disabled - Users cannot change their email', 'nobloat-user-foundry' ); ?>
					</option>
					<option value="enabled" <?php selected( $nbuf_allow_email_change, 'enabled' ); ?>>
		...
		<tr>
			...
			<td>
				...
				<label>
					<input type="checkbox" name="nbuf_verify_email_change" value="1" <?php checked( $nbuf_verify_email_change, true ); ?>>
		...
		<tr>
			...
			<td>
				<label>
					<input type="checkbox" name="nbuf_enable_expiration" value="1" <?php checked( $nbuf_enable_expiration, 1 ); ?>>
		...
		<tr>
			...
			<td>
				<input type="number" name="nbuf_expiration_warning_days" value="<?php echo esc_attr( $nbuf_warning_days ); ?>" min="1" max="90" class="small-text">
